...
export default class MiniMapControl extends L.Control {
    ...
    declare _mainMapMoving: any;
    declare _miniMapMoving: any;
    declare _minimized: any;
    declare "hideText": any;
    declare "showText": any;
    declare "_layer": any;
    declare "_mainMap": any;
    declare "_miniMap": any;
    declare "_userToggledDisplay": any;
    declare "_toggleDisplayButton": any;
    declare "_aimingRect": any;
    declare "_locationCircle": any;
    declare "_lastAimingRectPosition": any;
    declare "_shadowRect": any;
    declare "_lastMiniMapZoom": any;
    ...
    onAdd(map) {
        ...
        this._miniMap.whenReady(L.Util.bind(function(this: any) {
...
L.Map.addInitHook(function(this: any) {
    if (this.options.miniMapControl) {
        this.miniMapControl = (new (L.Control as any).MiniMap()).addTo(this);
    }
});

(L.control as any).minimap = function(options) {
    return new (L.Control as any).MiniMap(options);
};
