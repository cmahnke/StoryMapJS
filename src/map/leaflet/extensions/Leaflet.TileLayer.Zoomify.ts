...
export default class ZoomifyTileLayer extends L.TileLayer {
    declare _gridSize: any;
    declare options: any;
    declare _map: any;
    declare _tiles: any;
    declare _loadTile: any;
    declare "_url": any;
    declare "_imageSize": any;
    declare "_getTilePos": any;
    declare "_getTile": any;
    declare "_tileContainer": any;

	constructor(url, options: any = defaultZoomifyOptions) {
        super(url, options);
	...
	_addTile(tilePoint, container) {
		...
		(L.DomUtil as any).setPosition(tile, tilePos, (L.Browser as any).chrome || (L.Browser as any).android23);
