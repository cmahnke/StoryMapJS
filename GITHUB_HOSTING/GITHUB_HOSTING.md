...
_Your newly created repository should look like this, and contain one file named README.md._
...
_Clicking "Open in Desktop" should automatically launch the GitHub Desktop application._
...
_Move or copy everything from your Zoomify folder to your cloned folder._
...
_Your GitHub Desktop application should display all the files you moved into cloned folder._

![](7.png)

_After clicking "Commit and Sync master," you should be able to see all your Zoomify files in your GitHub repository._
...
_Copy this link to use as your Zoomify URL._
...
_Paste the link you copied from GitHub into the "Zoomify URL" text box to complete the process._
